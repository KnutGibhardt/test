Write-Host  -ForegroundColor Cyan "Starting BBraun OSDCloud ..."
...
Start-OSDCloud -OSLanguage en-us -OSBuild 22H2 -OSEdition Enterprise -OSName "Windows 11 22H2 x64" -ZTI
